...

          {
            isSchemaPopulated && !schemaError &&
              <div>
                ...
                {
                  soulseekDownloadClients.length > 0 &&
                    <FieldSet legend="Soulseek">
                      <div className={styles.downloadClients}>
                        {
                          soulseekDownloadClients.map((downloadClient) => {
                            return (
                              <AddDownloadClientItem
                                key={downloadClient.implementation}
                                implementation={downloadClient.implementation}
...
AddDownloadClientModalContent.propTypes = {
  ...
  soulseekDownloadClients: PropTypes.arrayOf(PropTypes.object).isRequired,
